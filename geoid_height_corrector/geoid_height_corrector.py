...
from .geoid_height_corrector_provider import GeoidHeightCorrectorProvider
...
class GeoidHeightCorrectorPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = GeoidHeightCorrectorProvider()
